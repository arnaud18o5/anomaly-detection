...
public class LevelShiftDetectionBolt extends BaseWindowedBolt {
    private IsolationForest model;
    private OutputCollector collector;

    @Override
    public void prepare(Map<String, Object> topoConf, TopologyContext context, OutputCollector collector) {
        model = new IsolationForest(Model.LEVEL_SHIFT);
    ...
    private void emitAlert(double metricValue) {
        this.collector.emit(new Values("level_shift", metricValue));
    }
    ...
    public Map<String, Object> getComponentConfiguration() {
        ...
        conf.put(Config.TOPOLOGY_BOLTS_WINDOW_LENGTH_DURATION_MS, 29000); // Fenêtre de 60 secondes
